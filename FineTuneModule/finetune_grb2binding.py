...
"""
================================================================
GRB2 Binding Score Fine-Tuning Pipeline
================================================================

End-to-end fine-tuning of a Protein Language Model + GRB2Regressor
head for SH2-domain peptide binding regression on a Deep Mutational
...
from predict_grb2binding import GRB2Regressor
...
def parse_args():
    p = argparse.ArgumentParser(
        description="GRB2 Binding Fine-Tuning — end-to-end PLM + regression head",
    ...
    p.add_argument("--log_name", type=str, default="ft_grb2binding")
...
def main():
    ...
    if is_main_process():
        logging.info("=" * 70)
        logging.info("GRB2 Binding Fine-Tuning Pipeline")
