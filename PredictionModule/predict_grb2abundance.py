...
"""
================================================================
GRB2 Abundance Score Prediction Pipeline
================================================================

Predicts continuous GRB2 variant abundance scores from a Deep
Mutational Scanning (DMS) dataset using protein embeddings.
...
def parse_args():
    p = argparse.ArgumentParser(
        description="GRB2 Abundance Score Regression — pre-extracted or on-the-fly embeddings",
    ...
    p.add_argument("--log_name", type=str, default="grb2abundance_pred")
...
class GRB2Regressor(nn.Module):
    """
    Lightweight prediction head for GRB2 abundance / fitness regression.
    ...
    def forward(self, emb: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            scores: (batch,)  predicted abundance / fitness scores
        """
...
def main():
    ...
    if is_main_process():
        logging.info("=" * 70)
        logging.info("GRB2 Abundance Score Prediction Pipeline")
